...
function createClient(params) {
  ...
  var userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["getUserAgentHeader"])("contentful.js/".concat("0.0.0-determined-by-semantic-release"), config.application, config.integration);
